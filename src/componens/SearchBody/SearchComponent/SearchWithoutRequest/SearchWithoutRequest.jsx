        ...
        <>
                    ...
                    components: {
                        ...
                        Button: {
                            colorPrimary: '#1390E5', // Основной цвет кнопки
                                ...
                                //controlWidth: 150, // Ширина кнопки
            ...
            >
                ...
                <Input placeholder="Что будем смотреть?" ref={ref} value={request} className={styles.inputStyle}
                    onChange={(e) => handleChange(e)} onKeyDown={(e) => handleKeyDown(e)} suffix={<HeartOutlined className={`${request === '' ? styles.disabled : styles.favorite} ${favorite.includes(request) ? styles.active : ''}`} onClick={() => handleFavorite()} />} />
